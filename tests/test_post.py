...
def test_get_all_posts(authorized_client, test_posts):
    ...
    def validate(post):
        return contracts.PostLikeResponse(**post)
...
def test_get_post_by_id_not_exit(authorized_client):
...
def test_get_post_by_id(authorized_client, test_posts):
    ...
    post = contracts.PostLikeResponse(**res.json())
...
@pytest.mark.parametrize(
    ...
    [
        ("create 1st title", "create 1st content", True),
        ("create 2nd title", "create 2nd content", False),
        ("create 3rd title", "create 3rd content", True),
    ],
)
def test_create_post(
    ...
    created_post = contracts.PostResponse(**res.json())
...
def test_update_post(authorized_client, test_user, test_posts):
    ...
    updated_post = contracts.Post(**res.json())
    assert res.status_code == 200
